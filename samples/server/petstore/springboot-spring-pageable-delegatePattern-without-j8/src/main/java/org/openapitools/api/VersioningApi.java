...
public interface VersioningApi {
    ...
    default ResponseEntity<ModelApiResponse> versioningMix(
        @ApiParam(value = "", required = true, defaultValue = "V1") @RequestParam(value = "VersionWithDefaultValueQuery", defaultValue = "V1") @NotNull String versionWithDefaultValueQuery,
        @ApiParam(value = "", required = true) @RequestParam(value = "VersionNoDefaultValueQuery") @NotNull String versionNoDefaultValueQuery,
    ...
    default ResponseEntity<ModelApiResponse> versioningQueryParams(
        @ApiParam(value = "", required = true, defaultValue = "V1") @RequestParam(value = "VersionWithDefaultValue", defaultValue = "V1") @NotNull String versionWithDefaultValue,
        @ApiParam(value = "", required = true) @RequestParam(value = "VersionNoDefaultValue") @NotNull String versionNoDefaultValue,
        @ApiParam(value = "ID of pet to update", required = true) @PathVariable("petId") @NotNull Long petId
    ) {
