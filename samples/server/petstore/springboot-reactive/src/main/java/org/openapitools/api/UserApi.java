...
public interface UserApi {
    ...
    default Mono<ResponseEntity<Void>> createUser(
        @ApiParam(value = "Created user object", required = true) @RequestBody Mono<@NotNull @Valid User> user,
    ...
    default Mono<ResponseEntity<Void>> createUsersWithArrayInput(
        @ApiParam(value = "List of user object", required = true) @RequestBody Flux<@Valid User> user,
        @ApiIgnore final ServerWebExchange exchange
    ) {
    ...
    default Mono<ResponseEntity<Void>> updateUser(
        ...
        @ApiParam(value = "Updated user object", required = true) @RequestBody Mono<@NotNull @Valid User> user,
        @ApiIgnore final ServerWebExchange exchange
    ) {
