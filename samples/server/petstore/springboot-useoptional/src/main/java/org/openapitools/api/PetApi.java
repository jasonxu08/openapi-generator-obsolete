...
public interface PetApi {
    ...
    default ResponseEntity<List<Pet>> findPetsByStatus(
        @ApiParam(value = "Status values that need to be considered for filter", required = true, allowableValues = "available, pending, sold") @RequestParam(value = "status") @NotNull List<Optional<String>> status
    ) {
    ...
    default ResponseEntity<Set<Pet>> findPetsByTags(
        @ApiParam(value = "Tags to filter by", required = true) @RequestParam(value = "tags") @NotNull Set<Optional<String>> tags
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<Void> updatePetWithForm(
        ...
        @ApiParam(value = "Updated name of the pet") @RequestParam(value = "name", required = false) Optional<String> name,
        @ApiParam(value = "Updated status of the pet") @RequestParam(value = "status", required = false) Optional<String> status
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
