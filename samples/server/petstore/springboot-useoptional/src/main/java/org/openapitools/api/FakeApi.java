...
public interface FakeApi {
    ...
    default ResponseEntity<Boolean> fakeOuterBooleanSerialize(
        @ApiParam(value = "Input boolean as post body") @RequestBody(required = false) Optional<Boolean> body
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<OuterComposite> fakeOuterCompositeSerialize(
        @ApiParam(value = "Input composite as post body") @RequestBody(required = false) Optional<@Valid OuterComposite> outerComposite
    ) {
    ...
    default ResponseEntity<BigDecimal> fakeOuterNumberSerialize(
        @ApiParam(value = "Input number as post body") @RequestBody(required = false) Optional<BigDecimal> body
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<String> fakeOuterStringSerialize(
        @ApiParam(value = "Input string as post body") @RequestBody(required = false) Optional<String> body
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> testEndpointParameters(
        ...
        @ApiParam(value = "None") @RequestParam(value = "integer", required = false) Optional<@Min(10) @Max(100) Integer> integer,
        @ApiParam(value = "None") @RequestParam(value = "int32", required = false) Optional<@Min(20) @Max(200) Integer> int32,
        @ApiParam(value = "None") @RequestParam(value = "int64", required = false) Optional<Long> int64,
        @ApiParam(value = "None") @RequestParam(value = "float", required = false) Optional<@DecimalMax("987.6") Float> _float,
        @ApiParam(value = "None") @RequestParam(value = "string", required = false) Optional<@Pattern(regexp = "/[a-z]/i") String> string,
        @ApiParam(value = "None") @RequestPart(value = "binary", required = false) MultipartFile binary,
        @ApiParam(value = "None") @RequestParam(value = "date", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Optional<LocalDate> date,
        @ApiParam(value = "None") @RequestParam(value = "dateTime", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Optional<OffsetDateTime> dateTime,
        @ApiParam(value = "None") @RequestParam(value = "password", required = false) Optional<@Size(min = 10, max = 64) String> password,
        @ApiParam(value = "None") @RequestParam(value = "callback", required = false) Optional<String> paramCallback
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> testEnumParameters(
        @ApiParam(value = "Header parameter enum test (string array)", allowableValues = ">, $") @RequestHeader(value = "enum_header_string_array", required = false) Optional<List> enumHeaderStringArray,
        ...
        @ApiParam(value = "Query parameter enum test (string array)", allowableValues = ">, $") @RequestParam(value = "enum_query_string_array", required = false) List<Optional<String>> enumQueryStringArray,
        ...
        @ApiParam(value = "Query parameter enum test (double)", allowableValues = "1.1, -1.2") @RequestParam(value = "enum_query_double", required = false) Optional<Double> enumQueryDouble,
        @ApiParam(value = "Form parameter enum test (string array)", allowableValues = ">, $", defaultValue = "$") @RequestPart(value = "enum_form_string_array", required = false) List<Optional<String>> enumFormStringArray,
        @ApiParam(value = "Form parameter enum test (string)", allowableValues = "_abc, -efg, (xyz)", defaultValue = "-efg") @RequestParam(value = "enum_form_string", required = false) Optional<String> enumFormString
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> testGroupParameters(
        ...
        @ApiParam(value = "String in group parameters") @RequestParam(value = "string_group", required = false) Optional<Integer> stringGroup,
        ...
        @ApiParam(value = "Integer in group parameters") @RequestParam(value = "int64_group", required = false) Optional<Long> int64Group
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> testInlineAdditionalProperties(
        @ApiParam(value = "request body", required = true) @RequestBody @NotNull Map<String, Optional<String>> requestBody
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> testQueryParameterCollectionFormat(
        @ApiParam(value = "", required = true) @RequestParam(value = "pipe") @NotNull List<Optional<String>> pipe,
        @ApiParam(value = "", required = true) @RequestParam(value = "http") @NotNull List<Optional<String>> http,
        @ApiParam(value = "", required = true) @RequestParam(value = "url") @NotNull List<Optional<String>> url,
        @ApiParam(value = "", required = true) @RequestParam(value = "context") @NotNull List<Optional<String>> context
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<ModelApiResponse> uploadFileWithRequiredFile(
        ...
        @ApiParam(value = "Additional data to pass to server") @RequestParam(value = "additionalMetadata", required = false) Optional<String> additionalMetadata
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
