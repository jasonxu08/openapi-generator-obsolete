...
public interface UserApi {
    ...
    default ResponseEntity<Void> createUser(
        @ApiParam(value = "Created user object", required = true) @RequestBody @NotNull @Valid UserDto userDto
    ) {
    ...
    default ResponseEntity<Void> createUsersWithArrayInput(
        @ApiParam(value = "List of user object", required = true) @RequestBody @NotNull List<@Valid UserDto> userDto
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> updateUser(
        ...
        @ApiParam(value = "Updated user object", required = true) @RequestBody @NotNull @Valid UserDto userDto
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
