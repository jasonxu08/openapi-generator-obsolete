...
internal struct EnumTest: Sendable, Codable {
    ...
    internal enum EnumString: String, Sendable, QueryStringEncodable, Codable, CaseIterable, CaseIterableDefaultsLast {
        case upper = "UPPER"
        case lower = "lower"
        case empty = ""
        case unknownDefaultOpenApi = "unknown_default_open_api"
    }
    internal enum EnumStringRequired: String, Sendable, QueryStringEncodable, Codable, CaseIterable, CaseIterableDefaultsLast {
        case upper = "UPPER"
        case lower = "lower"
        case empty = ""
        case unknownDefaultOpenApi = "unknown_default_open_api"
    }
    internal enum EnumInteger: Int, Sendable, QueryStringEncodable, Codable, CaseIterable, CaseIterableDefaultsLast {
        case _1 = 1
        case number1 = -1
        case unknownDefaultOpenApi = 11184809
    }
    internal enum EnumNumber: Double, Sendable, QueryStringEncodable, Codable, CaseIterable, CaseIterableDefaultsLast {
        case _11 = 1.1
        case number12 = -1.2
        case unknownDefaultOpenApi = 11184809
    }
