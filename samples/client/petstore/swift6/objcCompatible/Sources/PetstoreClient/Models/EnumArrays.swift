...
@objcMembers public class EnumArrays: NSObject, Codable {
    ...
    public enum JustSymbol: String, Sendable, QueryStringEncodable, Codable, CaseIterable {
        case greaterThanOrEqualTo = ">="
        case dollar = "$"
    }
    public enum ArrayEnum: String, Sendable, QueryStringEncodable, Codable, CaseIterable {
        case fish = "fish"
        case crab = "crab"
    }
