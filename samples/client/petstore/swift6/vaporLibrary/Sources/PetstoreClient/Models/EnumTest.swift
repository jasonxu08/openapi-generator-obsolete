...
public final class EnumTest: Content, Hashable {
    ...
    public enum EnumString: String, Sendable, QueryStringEncodable, Content, Hashable, CaseIterable {
        case upper = "UPPER"
        case lower = "lower"
        case empty = ""
    }
    public enum EnumStringRequired: String, Sendable, QueryStringEncodable, Content, Hashable, CaseIterable {
        case upper = "UPPER"
        case lower = "lower"
        case empty = ""
    }
    public enum EnumInteger: Int, Sendable, QueryStringEncodable, Content, Hashable, CaseIterable {
        case _1 = 1
        case number1 = -1
    }
    public enum EnumNumber: Double, Sendable, QueryStringEncodable, Content, Hashable, CaseIterable {
        case _11 = 1.1
        case number12 = -1.2
    }
