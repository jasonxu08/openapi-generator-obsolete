...
public final class EnumArrays: Content, Hashable {
    ...
    public enum JustSymbol: String, Sendable, QueryStringEncodable, Content, Hashable, CaseIterable {
        case greaterThanOrEqualTo = ">="
        case dollar = "$"
    }
    public enum ArrayEnum: String, Sendable, QueryStringEncodable, Content, Hashable, CaseIterable {
        case fish = "fish"
        case crab = "crab"
    }
